function Cliente(name, age, user, password, saldo = 0) {
    ...
    this.depositar = function(usuario, senha, valorDepositado, saldo) {
        /*CONTINUAR DAQUI!!*/ const usuario = prompt("Insira seu usuário:")
        let senha = prompt("Insira sua senha:")
        if (valorDepositado > 0 && valorDepositado != NaN) {
                if (usuario == this.user && senha == this.password) { 
